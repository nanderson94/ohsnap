...
var EventSource, Events, File, HTML, History, JSDOM, Screen, URL, XMLHttpRequest, createDocument, createWindow, jsdomDispatchElement, loadDocument;
...
module.exports = createWindow = function(_arg) {
  ...
  window.postMessage = function(data, targetOrigin) {
    ...
    event.data = data;
    event.source = browser._windowInScope;
  ...
  window._evaluate = function(code, filename) {
    ...
    try {
      ...
      if (typeof code === "string" || code instanceof String) {
        result = vm.runInContext(code, window);
      } else if (code) {
